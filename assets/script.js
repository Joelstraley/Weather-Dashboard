...
function runForecast(forecastURL){
    ...
    .then(function(forecastData){    
       // day1date.text((parseInt(forecastData.list[0].dt) * 1000).toLocaleSting("en-US", {timeZoneName: "short"}));
        day1date.text((dayjs((forecastData.list[0].dt * 1000)).format('M/DD/YYYY')));    
        ...
        day1icon.attr('src', "http://openweathermap.org/img/w/" + forecastData.list[0].weather.icon + ".png");
       
        day2date.text((dayjs((forecastData.list[9].dt * 1000)).format('M/DD/YYYY')));    
        ...
        day3date.text((dayjs((forecastData.list[17].dt * 1000)).format('M/DD/YYYY')));    
        ...
        day4date.text((dayjs((forecastData.list[25].dt * 1000)).format('M/DD/YYYY')));    
        ...
        day5date.text((dayjs((forecastData.list[33].dt * 1000)).format('M/DD/YYYY')));    
